    ...
    <div class="container-fluid feature bg-light py-5">
        <div class="container py-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                ...
                <h1 class="display-3 text-capitalize mb-3">Trusted by Public Agencies Nationwide</h1>
            </div>
            <div class="row g-4">
                <div class=" col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="feature-item p-4">
                        <div class="feature-icon mb-3"><i class="fas fa-hand-holding-water text-white fa-3x"></i></div>
                        <h5 class="mb-3">Certified Quality Assurance</h5>
                        <p>We adhere to ISO standards and conduct batch-wise quality inspections for safe consumption.</p>
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="feature-item p-4">
                        ...
                        <h5 class="mb-3">Multi-Stage Filtration</h5>
                        <p>Our 5-stage filtration system includes sediment, carbon, RO, UV, and mineral balancing.</p>
                        <a href="#" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="feature-item p-4">
                        ...
                        <h5 class="mb-3">Safe Mineral Composition</h5>
                        <p>Our water contains balanced electrolytes, sodium, and calcium levels — tested monthly in labs.
                        </p>
                        <a href="#" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                    <div class="feature-item p-4">
                        ...
                        <h5 class="mb-3">Third-Party Lab Testing</h5>
                        <p>Partnered with government-accredited labs for unbiased analysis and safety certifications.</p>
                        <a href="#" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
